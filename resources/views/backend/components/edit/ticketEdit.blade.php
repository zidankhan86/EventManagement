            ...
            <div class="card card-default">
                ...
                <div class="card-body">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" value="{{ $tickets->ticket_name }}" name="ticket_name" id="ticketName" placeholder="Enter ticket name" aria-label="">
                    </div>
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group">
                                <label class="text-dark font-weight-medium" for="price">Price</label>
                                <input type="text" class="form-control" value="{{ $tickets->price }}" name="price" id="price" placeholder="Enter ticket price" aria-label="">
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="form-group">
                                <label class="text-dark font-weight-medium" for="quantityAvailable">Quantity Available</label>
                                <input type="text" class="form-control" value="{{ $tickets->quantity }}" name="quantity" id="quantityAvailable" placeholder="Enter quantity available" aria-label="">
                            </div>
                        </div>
                    </div>
                </form>
                    <div class="text-center">
                        <button type="button" id="createTicket" class="btn btn-dark">Save Ticket</button>
                    </div>
                </div>
            </div>
        </div>
