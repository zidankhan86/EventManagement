            ...
            <div class="card card-default">
                ...
                <div class="card-body">
                    ...
                    <div class="form-group">
                        ...
                        <input type="date" class="form-control" name="date" id="registrationDate" placeholder="Enter registration date" aria-label="">
                    </div>
                    <div class="form-group">
                        <label class="text-dark font-weight-medium" for="registrationStatus">Registration Status</label>
                        <select class="form-control" name="status" id="registrationStatus">
